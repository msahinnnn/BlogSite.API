...
namespace BlogSite.DataAccsess.Concrete.AdoNet
{
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<User> CheckUserEmailExistsAsync(string mail)
        {
            ...
            //user.Token = ds.Tables[0].Rows[0]["Token"].ToString();
            //user.RefreshToken= ds.Tables[0].Rows[0]["RefreshToken"].ToString();
            //user.RefreshTokenExpiryTime = DateTime.Parse(ds.Tables[0].Rows[0]["RefreshTokenExpiryTime"].ToString());
            //if(user != null)
            //{
            //    await con.CloseAsync();
            //    await con.DisposeAsync();
            ...
            //    user.RefreshToken = reader["RefreshToken"].ToString();
            //    user.RefreshTokenExpiryTime = DateTime.Parse(reader["RefreshTokenExpiryTime"].ToString());
            //    await con.CloseAsync();
            //    await con.DisposeAsync();
            //    return user;
            //}
